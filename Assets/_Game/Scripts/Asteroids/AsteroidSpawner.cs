...
namespace Asteroids
{
    ...
    public class AsteroidSpawner : MonoBehaviour
    {
        ...
        {
            if (_spawnPosIndex._value == 1)
                return SpawnLocation.Bottom;
            else if (_spawnPosIndex._value == 2)
                return SpawnLocation.Left;
            else if (_spawnPosIndex._value == 3)
                return SpawnLocation.Right;
            else if (_spawnPosIndex._value == 4)
                return SpawnLocation.Top;
            else
            {
